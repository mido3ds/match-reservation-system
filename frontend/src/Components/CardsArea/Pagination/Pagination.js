...
function Pagination({ paginate, hasNext }) {
  ...
  return (
    <div className="pagination-wrapper">
      <svg id="dec-btn" className="custom-btn btn btn--prev" height="96" viewBox="0 0 24 24" width="96"
      ...
      <svg id="inc-btn" className="custom-btn btn btn--next" height="96" viewBox="0 0 24 24" width="96"
